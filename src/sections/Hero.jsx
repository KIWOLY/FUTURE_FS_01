                    ...
                    <div className='relative animate-fade-in animation-delay-400'>
                        ...
                        <div className='relative max-w-md mx-auto'>
                            <div className='relative glass rounded-3xl p-2 glow-border'>
                                <img src="/profile43.jpeg" alt="Innocent Kiwoly Backend Developer & Cloud/DevOps Engineer profile photo" loading="lazy" className='w-full aspect-[4/5] object-cover rounded-2xl' />
